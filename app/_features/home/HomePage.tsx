        ...
        <Container>
          <div className="py-32 pt-28 flex flex-col gap-12 items-center">
            <div className="flex flex-col gap-4 text-center items-center">
              <h1 className={h1}>Location based pricing for your Airbnb</h1>
            ...
            <div className="flex flex-col items-center gap-14">
              <div className="flex flex-col gap-4 text-center">
                ...
                <div className={textBig}>
                  PriceBee shows you what to charge for your Airbnb.
                </div>
              </div>
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex flex-col  items-center text-center flex-grow max-w-[480px]">
                  ...
                  <div className={`mt-4 ${h3}`}>Enter your city</div>
                  <div className={`mt-2 ${textMedium}`}>
                    PriceBee needs to know where your Airbnb is, so it can look
                    for local events and demand.
                  </div>
                </div>
                <div className="flex flex-col items-center text-center flex-grow max-w-[480px]">
                  <div className="h-16 w-16 flex items-center justify-center relative border rounded-md">
        ...
        <Container>
          <div className="py-24 flex flex-col gap-8 items-center">
            ...
            <p className={`${textMedium} max-w-[460px] text-center`}>
              Ready to start? Enter your city and a minimum price to see daily
              pricing suggestions.
            </p>
            <CalendarSearchBar />
          </div>
